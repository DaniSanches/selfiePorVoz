...
function take_snapshot() {
  // Webcam.snap() é uma função predefinida de webcam.js utilizada para tirarmos uma
  // selfie. Essa função contém data_uri, utilizado para mostrar a pré-visualização gerada após tirar a selfie
